...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 10 fév. 2023 à 11:18
...
DROP TABLE IF EXISTS `awaiting_intervention`;
CREATE TABLE IF NOT EXISTS `awaiting_intervention` (
...
CREATE TABLE IF NOT EXISTS `login_attempt` (
  `id_login_attempt` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `trace` (
  `id_trace` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_user` int NOT NULL,
