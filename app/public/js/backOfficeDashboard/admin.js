...
function addUserAdmin() {
    ...
    tab_fields_modal[$('input[name=civilite]:checked').attr('name')] = $('input[name=civilite]:checked').val();
    tab_fields_modal['typeAccount'] = $('input[name=optionTypeAdmin]:checked').val();
    $(".modal-add").each(
        function () {
