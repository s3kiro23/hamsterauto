...
function horaires(){
    ...
    var semaine = [
        ["Dimanche"],
        // 0	   1     2     3       4     //
        ["Lundi", 7.30, 8.00, 17.30, 18.00],
        ["Mardi", 7.30, 8.00, 17.30, 18.00],
        ["Mercredi", 7.30, 8.00, 17.30, 18.00],
        ["Jeudi", 7.30, 8.00, 17.30, 18.00],
        ["Vendredi", 7.30, 8.00, 17.30, 18.00],
        ["Samedi", 7.30, 8.00, 17.30, 18.00] 
    ];
